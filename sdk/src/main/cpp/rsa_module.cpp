...
Java_com_ms_module_ndk_rsa_RSA_GetAPublicKey(JNIEnv *env, jobject thiz) {
...
JNIEXPORT jstring JNICALL
Java_com_ms_module_ndk_rsa_RSA_GetBPublicKey(JNIEnv *env, jobject thiz) {
...
JNIEXPORT jstring JNICALL
Java_com_ms_module_ndk_rsa_RSA_GetBPrivateKey(JNIEnv *env, jobject thiz) {
...
JNIEXPORT jstring JNICALL
Java_com_ms_module_ndk_rsa_RSA_GetAPrivateKey(JNIEnv *env, jobject thiz) {
